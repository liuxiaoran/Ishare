...
public class PoiSearchDemo extends FragmentActivity implements
    ...
    private static final String TAG="tmdpoi";
    /**
     * 搜索关键字输入窗口
     */
    ...
    private class MyPoiOverlay extends PoiOverlay {
        ...
        public boolean onPoiClick(int index) {
            ...
            Log.v(TAG,poi.address+"address"+" name"+poi.name+ " "+poi.postCode);
            Log.v(TAG,index+"index");
            Toast.makeText(PoiSearchDemo.this,poi.address,Toast.LENGTH_LONG).show();
